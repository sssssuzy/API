...
public class NaverAPI {
 ...
 public static String connection(String query) throws Exception{
     String clientId = "qUsZFBq6Jp5iQ3TQjOJd"; //애플리케이션 클라이언트 아이디값"
     String clientSecret = "AmP078fyqM"; //애플리케이션 클라이언트 시크릿값"
     ...
     //String apiURL = "https://openapi.naver.com/v1/search/shop.json="+ text; // xml 결과
